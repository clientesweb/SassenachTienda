        ...
        if (category === 'all' || product.category === category) {
            ...
            productElement.innerHTML = `
                ...
                <div class="p-4">
                    ...
                    <button class="mt-4 bg-[#EAE4D2] text-white px-4 py-2 rounded-full hover:bg-blue-600 transition duration-300" onclick="addToCart(${product.id})">Agregar al carrito</button>
                </div>
            `;
    ...
    featuredProducts.forEach(product => {
        ...
        productElement.innerHTML = `
            ...
            <div class="p-4">
                <h3 class="text-lg font-semibold mb-2">${product.name}</h3>
                <p class="text-gray-600">$${product.price.toFixed(2)}</p>
                <button class="mt-4 bg-primary text-white px-4 py-2 rounded-full hover:bg-[#EAE4D2] transition duration-300" onclick="addToCart(${product.id})">Agregar al carrito</button>
            </div>
        `;
